...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int code1,int code2, Intent intent) {
        ...
        switch(code1) {
            case EDIT:
                reName= intent.getStringExtra("KEY_NAME");
                Toast.makeText(MainActivity.this, "Hello " +reName, Toast.LENGTH_LONG ).show();
                break;
        }
    }
